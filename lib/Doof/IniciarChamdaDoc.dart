...
class IniciarChamadaDoc extends StatefulWidget {
  String _code;
  IniciarChamadaDoc(this._code);
  @override
  _IniciarChamadaDocState createState() => _IniciarChamadaDocState();
}

class _IniciarChamadaDocState extends State<IniciarChamadaDoc> {
