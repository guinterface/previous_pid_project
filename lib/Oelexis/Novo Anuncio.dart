...
class _NovoAnuncioState extends State<NovoAnuncio> {
  ...
  _salvarAnuncio() async {
    ...
    _anuncio.geohash = Geohash.encode(_anuncio.latitude, _anuncio.longitude);
              ...
              children: <Widget>[
                ...
                Padding(
                  ...
                  child: InputCustomizado(
                    hint: "Latitude",
                    onSaved: (titulo){
                      _anuncio.latitude = double.parse(titulo);
                    },
                    validator: (valor){
                      return Validador()
                          .add(Validar.OBRIGATORIO, msg: "Campo obrigatório")
                ...
                Padding(
                  ...
                  child: InputCustomizado(
                    hint: "Longitude",
                    onSaved: (longitude){
                      _anuncio.longitude = double.parse(longitude);
                    },
                    validator: (valor){
                      return Validador()
                          .add(Validar.OBRIGATORIO, msg: "Campo obrigatório")
