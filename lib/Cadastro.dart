...
import 'package:i_health/Chercher/TesteDoutor.dart';
            ...
            child: Column(
              ...
              children: <Widget>[
                Padding(
                  ...
                  child: Text("Cadastre-se aqui", style: TextStyle(color: Colors.green, fontWeight: FontWeight.bold, fontSize: 32),)
                ),
                Padding(
